...
<html lang="en">
	...
	<body class="loader">
       ...
       <?php include 'nav.php'; ?>
		...
		<main class="animsition-overlay" data-animsition-overlay="true" style="margin-bottom: 396px; opacity: 1;">
			<!-- home-slider start -->
			<section class="home-slider _mPS2id-t swiper-container-horizontal swiper-container-autoheight mPS2id-target mPS2id-target-first mPS2id-target-last" id="up">
				<!-- swiper-wrapper start -->
			  	<div class="swiper-wrapper" style="height: 678px; transition-duration: 1500ms; transform: translate3d(0px, 0px, 0px);">
				  	<!-- swiper-slide start -->
				  	<div class="swiper-slide flex-min-height-box home-slide swiper-slide-active" style="width: 1286px; transition: 1500ms;">
					  	<!-- slide-bg -->
				      	<div class="slide-bg overlay-loading2 overlay-dark-bg-1" style="background-image: url(&quot;assets/images/backgrounds/pexels-photo-1806031.jpeg&quot;); transform: translate3d(0px, 0px, 0px); transition: 1500ms;"></div>
				    ...
				    <!-- swiper-slide start -->
				    <div class="swiper-slide flex-min-height-box home-slide swiper-slide-next" style="width: 1286px; transition: 1500ms;">
					    <!-- slide-bg -->
				      	<div class="slide-bg" style="background-image: url(&quot;assets/images/backgrounds/adolescent-adult-diversity-1034361.jpg&quot;); transform: translate3d(-643px, 0px, 0px); transition: 1500ms;"></div>
				      	<!-- home-slider-content start -->
				    ...
				    <!-- swiper-slide start -->
				    <div class="swiper-slide flex-min-height-box home-slide red-slide" style="width: 1286px; transition: 1500ms;">
					    <!-- slide-bg -->
				      	<div class="slide-bg" style="background-image: url(&quot;assets/images/backgrounds/bart-simpson-casual-close-up-1813947copy1.jpg&quot;); transform: translate3d(-1286px, 0px, 0px); transition: 1500ms;"></div>
				      	<!-- home-slider-content start -->
			...
			<section id="down" class="dark-bg-1 flex-min-height-box _mPS2id-t">
						...
						<div data-animation-container="" class="flex-container animated">
							...
							<div class="twelve-columns text-center">
								<h2 class="large-title text-height-12">
									<span data-animation-child="" class="title-fill animated title-fill-anim" data-animation="title-fill-anim" data-text="We are Creative">We are Creative</span><br>
									<span data-animation-child="" class="title-fill tr-delay01 animated title-fill-anim" data-animation="title-fill-anim" data-text="We are Xen">We are Xen</span>
								</h2>
							</div><!-- column end -->
							<!-- column start -->
							<div class="six-columns">
								<div class="content-right-margin-20">
									<p data-animation-child="" class="p-style-medium text-color-5 fade-anim-box tr-delay02 animated fade-anim" data-animation="fade-anim">Affogato thundercats quinoa, portland cold-pressed edison bulb artisan paleo banjo tousled try-hard food truck pop-up bushwick godard. Occupy 90's try-hard tote bag chicharrones stumptown polaroid hashtag cliche +1, tousled fanny pack. Tote bag iPhone crucifix hella helvetica food truck bicycle rights cloud bread. Yr iPhone asymmetrical, next level vexillologist godard blog green juice chia. Tacos jean shorts pickled PBR&amp;B poutine.</p>
								</div>
							</div><!-- column end -->
							<!-- column start -->
							<div class="six-columns">
								<div class="content-left-margin-20">
									<p data-animation-child="" class="p-style-medium text-color-5 fade-anim-box tr-delay03 animated fade-anim" data-animation="fade-anim">Godard slow-carb chartreuse occupy, tumblr letterpress pok pok tattooed yr lyft yuccie kinfolk. IPhone kombucha shaman gastropub snackwave 90's lo-fi pug chillwave pok pok tofu. Swag deep v listicle roof party seitan man braid raclette church-key trust fund locavore vexillologist green juice raw denim tilde meh. Austin thundercats locavore taiyaki snackwave hoodie put a bird on it tattooed selvage kitsch ramps. </p>
								</div>
							</div><!-- column end -->
							<!-- column start -->
							<div class="twelve-columns text-center">
								<p data-animation-child="" class="p-letter-style text-color-4 text-height-13 fade-anim-box tr-delay04 animated fade-anim" data-animation="fade-anim">Godard slow-carb chartreuse occupy, tumblr letterpress</p>
							</div><!-- column end -->
						</div><!-- flex-container end -->
					</div><!-- container end -->
			...
			<section class="light-bg-1 bottom-padding-30 top-padding-120" data-midnight="black">
				...
				<div data-animation-container="" class="container small bottom-padding-60 text-center animated">
					<h2 data-animation-child="" class="large-title text-height-10 text-color-1 overlay-anim-box2 animated overlay-anim2" data-animation="overlay-anim2">Recent Works</h2><br>
					...
					<div class="portfolio-content flex-min-height-box">
						...
						<div class="portfolio-content-inner flex-min-height-inner">
							...
							<div class="flex-container container small">
								<!-- column start -->
								<div data-animation-container="" class="six-columns animated">
									<div class="content-right-margin-40">
										<span class="small-title-oswald red-color overlay-anim-box2 animated overlay-anim2" data-animation="overlay-anim2">Commercial</span>
										<h3 class="title-style text-color-1">
											<span data-animation-child="" class="overlay-anim-box2 overlay-dark-bg-2 tr-delay01 animated overlay-anim2" data-animation="overlay-anim2">Bushwick selfies</span><br>
											<span data-animation-child="" class="overlay-anim-box2 overlay-dark-bg-2 tr-delay02 animated overlay-anim2" data-animation="overlay-anim2">pork belly lyft</span><br>
											<span data-animation-child="" class="overlay-anim-box2 overlay-dark-bg-2 tr-delay03 animated overlay-anim2" data-animation="overlay-anim2">brooklyn messeng</span>
										</h3>
										<p data-animation-child="" class="p-style-small text-color-2 fade-anim-box tr-delay04 animated fade-anim" data-animation="fade-anim">Narwhal pop-up intelligentsia tbh pinterest, microdosing tilde cloud bread gochujang tattooed leggings cornhole 8-bit. Austin fam chia cold-pressed raw denim. Glossier drinking vinegar portland lo-fi, polaroid bespoke lomo. Banjo art party XOXO, fashion axe sustainable retro ethical gentrify.</p>
								...
								<div class="six-columns top-padding-60">
									<a href="project.html" class="portfolio-content-bg-box pointer-large hover-box hidden-box animsition-link">
										<div class="portfolio-content-bg hover-img overlay-anim-box2 overlay-dark-bg-2 animated overlay-anim2" data-animation="overlay-anim2" style="background-image:url(assets/images/projects/pexels-photo-1619654.jpeg)"></div>
									</a>
								</div><!-- column end -->
							</div><!-- flex-container end -->
					...
					<div class="portfolio-content flex-min-height-box">
						...
						<div class="portfolio-content-inner flex-min-height-inner">
							...
							<div class="flex-container reverse container small">
								...
								<div class="six-columns top-padding-60">
									<a href="project.html" class="portfolio-content-bg-box pointer-large hover-box hidden-box animsition-link">
										<div class="portfolio-content-bg hover-img overlay-anim-box2 overlay-dark-bg-2 animated overlay-anim2" data-animation="overlay-anim2" style="background-image:url(assets/images/projects/audio-cassette-cassette-tape-1626481.jpg)"></div>
									</a>
								</div><!-- column end -->
								<!-- column start -->
								<div data-animation-container="" class="six-columns animated">
									<div class="content-left-margin-40">
										<span class="small-title-oswald red-color overlay-anim-box2 animated overlay-anim2" data-animation="overlay-anim2">Graphic Design</span>
										<h3 class="title-style text-color-1">
											<span data-animation-child="" class="overlay-anim-box2 overlay-dark-bg-2 tr-delay01 animated overlay-anim2" data-animation="overlay-anim2">tumeric tumblr</span><br>
											<span data-animation-child="" class="overlay-anim-box2 overlay-dark-bg-2 tr-delay02 animated overlay-anim2" data-animation="overlay-anim2">gluten-free</span><br>
											<span data-animation-child="" class="overlay-anim-box2 overlay-dark-bg-2 tr-delay03 animated overlay-anim2" data-animation="overlay-anim2">Man bun small</span>
										</h3>
										<p data-animation-child="" class="p-style-small text-color-2 fade-anim-box tr-delay04 animated fade-anim" data-animation="fade-anim">Slow-carb green juice subway tile bicycle rights, fanny pack raclette palo santo put a bird on it mustache actually fam mumblecore iPhone. Iceland post-ironic health goth snackwave, mixtape synth four dollar toast sartorial. Health goth la croix vexillologist, before they sold out shabby chic.</p>
					...
					<div class="portfolio-content flex-min-height-box">
						...
						<div class="portfolio-content-inner flex-min-height-inner">
							...
							<div class="flex-container container small">
								...
								<div data-animation-container="" class="six-columns animated">
									<div class="content-right-margin-40">
										<span class="small-title-oswald red-color overlay-anim-box2 animated overlay-anim2" data-animation="overlay-anim2">Branding</span>
										<h3 class="title-style text-color-1">
											<span data-animation-child="" class="overlay-anim-box2 overlay-dark-bg-2 tr-delay01 animated overlay-anim2" data-animation="overlay-anim2">batch kombucha</span><br>
											<span data-animation-child="" class="overlay-anim-box2 overlay-dark-bg-2 tr-delay02 animated overlay-anim2" data-animation="overlay-anim2">subway tile</span><br>
											<span data-animation-child="" class="overlay-anim-box2 overlay-dark-bg-2 tr-delay03 animated overlay-anim2" data-animation="overlay-anim2">salvia brooklyn</span>
										</h3>
										<p data-animation-child="" class="p-style-small text-color-2 fade-anim-box tr-delay04 animated fade-anim" data-animation="fade-anim">Mlkshk YOLO wolf, leggings vinyl crucifix stumptown tousled. Pabst venmo gentrify deep v microdosing migas occupy master cleanse intelligentsia sartorial chia activated charcoal. Iceland small batch live-edge raclette roof party dreamcatcher austin pickled. Chillwave cronut messenger bag truffaut.</p>
								...
								<div class="six-columns top-padding-60">
									<a href="project.html" class="portfolio-content-bg-box pointer-large hover-box hidden-box animsition-link">
										<div class="portfolio-content-bg hover-img overlay-anim-box2 overlay-dark-bg-2 animated overlay-anim2" data-animation="overlay-anim2" style="background-image:url(assets/images/projects/blur-close-up-equipment-1034651.jpg)"></div>
									</a>
								</div><!-- column end -->
							</div><!-- flex-container end -->
						</div><!-- portfolio-content-inner end -->
			...
			<div class="light-bg-2 top-bottom-padding-120" data-midnight="black">
				...
				<div class="testimonials-slider container small swiper-container-horizontal swiper-container-autoheight">
					<!-- swiper-wrapper start -->
					<div class="swiper-wrapper" style="height: 421px; transform: translate3d(-3960px, 0px, 0px); transition-duration: 1200ms;"><div class="swiper-slide text-center swiper-slide-duplicate swiper-slide-duplicate-next" data-swiper-slide-index="4" style="width: 960px; margin-right: 30px;">
						...
						<!-- slide start -->
						<div class="swiper-slide text-center" data-swiper-slide-index="0" style="width: 960px; margin-right: 30px;">
						...
						<!-- slide start -->
						<div class="swiper-slide text-center" data-swiper-slide-index="1" style="width: 960px; margin-right: 30px;">
						...
						<!-- slide start -->
						<div class="swiper-slide text-center swiper-slide-prev" data-swiper-slide-index="2" style="width: 960px; margin-right: 30px;">
						...
						<!-- slide start -->
						<div class="swiper-slide text-center swiper-slide-active" data-swiper-slide-index="3" style="width: 960px; margin-right: 30px;">
						...
						<!-- slide start -->
						<div class="swiper-slide text-center swiper-slide-next" data-swiper-slide-index="4" style="width: 960px; margin-right: 30px;">
							<img src="assets/images/testimonials/pexels-photo-894156.jpeg" alt="author">
							<div class="testimonials-content">
								<p class="text-color-4 p-style-bold">Pok pok authentic fashion axe, vegan venmo leggings raclette tousled twee tattooed. Banh mi humblebrag hammock tacos fashion axe aesthetic vegan sustainable taiyaki thundercats jean shorts tousled cloud bread waistcoat kogi. Cloud bread cardigan messenger bag raw denim swag drinking vinegar. Yuccie jianbing bespoke retro, photo booth salvia hella meh post-ironic cornhole tacos plaid.</p>
							</div>
					...
					<div class="swiper-slide text-center swiper-slide-duplicate" data-swiper-slide-index="0" style="width: 960px; margin-right: 30px;">
							<img src="assets/images/testimonials/adult-beanie-black-background-1529350.jpg" alt="author">
							<div class="testimonials-content">
								<p class="text-color-4 p-style-bold">Copper mug vexillologist +1 prism iPhone fashion axe portland. Hella quinoa woke blog af umami tacos freegan vinyl snackwave microdosing. Fanny pack direct trade XOXO drinking vinegar. Live-edge kinfolk master cleanse brooklyn meh organic man braid. Actually humblebrag sriracha authentic chia. IPhone glossier schlitz fam, la croix keytar retro offal. Artisan selfies mlkshk pinterest gastropub knausgaard live-edge.</p>
							</div>
